    ...
    <section className="w-full pt-36 md:pt-48 pb-10 relative overflow-hidden">
      <div className="space-y-6 text-center">
        <div className="space-y-6 mx-auto">
          <h1 className="text-5xl font-bold md:text-6xl lg:text-7xl xl:text-8xl gradient-title animate-gradient text-center">
        ...
        <div className="hero-image-wrapper mt-5 md:mt-0 relative w-full max-w-[1280px] mx-auto">
          <div ref={imageRef} className="hero-image w-full">
            <Image
              ...
              className="rounded-lg shadow-2xl border w-full object-cover"
              priority
            />
          </div>
        </div>
